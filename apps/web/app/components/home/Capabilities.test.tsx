...
describe("Capabilities", () => {
  it("renders three capabilities with project evidence", () => {
    ...
    expect(screen.getByRole("heading", { name: "Infrastructure & delivery" })).toBeInTheDocument();
    expect(screen.getByRole("heading", { name: "Cloud-native backend" })).toBeInTheDocument();
    expect(screen.getByRole("heading", { name: "Connected systems & telemetry" })).toBeInTheDocument();
