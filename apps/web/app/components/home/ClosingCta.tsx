...
export function ClosingCta({ onOpenResume }: ClosingCtaProps) {
  return (
    <section className="px-4 pb-20 pt-10 sm:px-8 sm:pb-28 sm:pt-16">
      <div className="mx-auto grid max-w-7xl gap-8 border-y border-[var(--outline-variant)]/30 py-12 lg:grid-cols-[1fr_auto] lg:items-end lg:py-16">
        ...
        <div className="flex flex-col gap-3 sm:flex-row lg:justify-end">
          <Link
            href="/contact"
            className="inline-flex min-h-12 items-center justify-center rounded-lg bg-[var(--primary)] px-6 font-bold text-[var(--on-primary)] transition-colors hover:bg-[var(--primary-fixed)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--tertiary)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--background)]"
          >
          ...
          <button
            ...
            className="inline-flex min-h-12 items-center justify-center px-5 font-bold text-[var(--foreground)] underline decoration-[var(--outline-variant)] underline-offset-4 hover:decoration-[var(--foreground)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--tertiary)]"
          >
            View resume
          </button>
        </div>
