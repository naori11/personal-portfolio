...
export const metadata: Metadata = {
  title: "INFRA_DEV | Project Gallery",
  description: "Deployment Archive - Infrastructure Projects",
};
    ...
    <main className="pt-32 pb-24 px-8 max-w-7xl mx-auto">
      ...
      <header className="mb-20 max-w-3xl">
        <div className="flex items-center gap-3 mb-4">
          <span className="w-3 h-3 bg-[#6bd8cb] rounded-full"></span>
        ...
        <h1 className="font-[family-name:var(--font-space-grotesk)] text-5xl md:text-7xl font-bold text-[#dae2fd] tracking-tighter mb-6">
          Engineered <span className="text-[#cfbdff] italic">Systems.</span>
        </h1>
        <p className="text-lg text-[#b9c7df] leading-relaxed max-w-2xl">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {projects.map((project, index) => (
          <div
            key={index}
            className={`group relative bg-[#131b2e] p-1 rounded-lg transition-all duration-500 hover:shadow-[0_0_30px_rgba(207,189,255,0.15)] ${project.offset || ""}`}
          >
      ...
      {/* CTA Section */}
      <section className="mt-32 p-12 bg-[#131b2e] border border-[#494456]/15 rounded-sm relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-xl">
          ...
          <Link href="/contact" className="inline-block bg-gradient-to-r from-[#cfbdff] to-[#6200ee] text-[#3a0093] px-8 py-3 font-[family-name:var(--font-jetbrains-mono)] font-bold text-sm tracking-widest uppercase rounded-lg hover:shadow-[0_0_20px_rgba(207,189,255,0.3)] transition-all active:scale-95">
            ESTABLISH CONTACT
          </Link>
        </div>
      </section>
